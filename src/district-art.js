...
function window(c,x,y,w=35,h=48){box(c,x-3,y-3,w+6,h+6,'#f9e7bc',4);box(c,x,y,w,h,'#547f91',2);poly(c,[[x+3,y+3],[x+w-3,y+3],[x+3,y+h-3]],'#a5cbd0');line(c,x+w/2,y,x+w/2,y+h,'#eadcbc',3);box(c,x-5,y+h, w+10,5,'#647e82',2);}
