...
export const lab = {
  ...
  solids:[
    ...
    {id:'slope-base',x:555,y:814,w:45,h:56},
    {id:'slide-roof',x:770,y:814,w:170,h:30},
    {id:'wall-a',x:1030,y:480,w:50,h:300},{id:'wall-b',x:1200,y:540,w:50,h:240},
  ...
  hazards:[{id:'pit',name:'Hit the striped floor',hint:'Jump before the conveyor ends. Clear the coral-striped strip.',x:1690,y:857,w:60,h:13},{id:'crusher',name:'Hit the overhead hazard',hint:'Move sideways as the piston launches you. The striped ceiling is unsafe.',x:2160,y:380,w:100,h:24}],
  labels:[
    {x:65,y:765,title:'01 / BUILD MOMENTUM',sub:'Tap → jog → sprint → SEND IT'},
    {x:555,y:725,title:'02 / SLOPE + SLIDE',sub:'Hold S. Keep the speed.'},
    {x:995,y:450,title:'03 / WALL SHAFT',sub:'Enter below. Alternate walls + fresh jump presses.'},
    {x:995,y:820,title:'→ WALK THROUGH TO CONTINUE',sub:'Wall climb is an optional upper route.'},
